...
- [x] **Phase 13B is not regressed**: the Jetson node's `--perception-backend` defaults to `dummy`, the loopback gate still reports Prepared with fault matrix 28/28, Phase 13A SIL still 28/28, portable C CTest still 2/2, Phase 11 8/8 and demo checks 6/6.
